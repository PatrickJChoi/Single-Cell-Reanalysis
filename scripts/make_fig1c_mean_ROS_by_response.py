...
OUTFIG = Path("results/figures/fig1c_delta_mean_ROS.png")
...
def main():
    ...
    ax.set_title("TAURUS discovery: Mean ROS change by response")
    ax.set_ylabel("Delta(Post - Pre) mean ROS module score")
